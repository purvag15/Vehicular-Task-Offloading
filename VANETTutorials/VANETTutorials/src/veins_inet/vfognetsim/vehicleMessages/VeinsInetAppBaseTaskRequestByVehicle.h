...
class VEINS_INET_API VeinsInetAppBaseTaskRequestByVehicle : public inet::ApplicationBase, public inet::UdpSocket::ICallback {
protected:
...
public:
    VeinsInetAppBaseTaskRequestByVehicle();
    ~VeinsInetAppBaseTaskRequestByVehicle();
};
