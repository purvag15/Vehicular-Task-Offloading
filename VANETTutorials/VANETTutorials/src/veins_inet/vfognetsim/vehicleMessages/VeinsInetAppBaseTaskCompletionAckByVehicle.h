...
class VEINS_INET_API VeinsInetAppBaseTaskCompletionAckByVehicle : public inet::ApplicationBase, public inet::UdpSocket::ICallback {
protected:
...
public:
    VeinsInetAppBaseTaskCompletionAckByVehicle();
    ~VeinsInetAppBaseTaskCompletionAckByVehicle();
};
