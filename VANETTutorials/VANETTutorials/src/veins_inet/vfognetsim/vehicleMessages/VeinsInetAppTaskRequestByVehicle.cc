#include "veins_inet/vfognetsim/vehicleMessages/VeinsInetAppTaskRequestByVehicle.h"
...
Define_Module(VeinsInetAppTaskRequestByVehicle);

VeinsInetAppTaskRequestByVehicle::VeinsInetAppTaskRequestByVehicle()
{
}

bool VeinsInetAppTaskRequestByVehicle::startApplication()
{
...
bool VeinsInetAppTaskRequestByVehicle::stopApplication()
{
    return true;
}
...
void VeinsInetAppTaskRequestByVehicle::processPacket(std::shared_ptr<inet::Packet> pk)
{
