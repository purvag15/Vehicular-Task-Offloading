...
class VEINS_INET_API VeinsInetAppBaseTaskRequestByVehicle_1 : public inet::ApplicationBase, public inet::UdpSocket::ICallback {
protected:
...
public:
    VeinsInetAppBaseTaskRequestByVehicle_1();
    ~VeinsInetAppBaseTaskRequestByVehicle_1();
};
