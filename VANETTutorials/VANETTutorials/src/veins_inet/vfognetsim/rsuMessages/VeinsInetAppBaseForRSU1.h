...
class VEINS_INET_API VeinsInetAppBaseForRSU1 : public inet::ApplicationBase, public inet::UdpSocket::ICallback {
protected:
...
protected:
    ...
    virtual void sendPacketToNode(std::unique_ptr<inet::Packet> pk);

public:
    VeinsInetAppBaseForRSU1();
    ~VeinsInetAppBaseForRSU1();
};
